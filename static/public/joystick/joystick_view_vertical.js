...
JoystickView = Backbone.View.extend({
    ...
    initialize: function(squareSize, finishedLoadCallback){
        ...
        this.template = _.template($("#joystick-view-vertical").html());
        this.state = INACTIVE;
        this.x = 0;
        this.y = 0;
        this.canvas = null;
    ...
    renderSprite: function(){
        ...
        var coords = this._cartesianToCanvas(0, this.y);
    ...
    render: function(){
        ...
        this.canvas = this.$('#joystickCanvasVertical')[0];
