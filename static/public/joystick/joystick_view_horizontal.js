...
JoystickViewHorizontal = Backbone.View.extend({
    events: {
    ...
    initialize: function(squareSize, finishedLoadCallback){
        ...
        this.template = _.template($("#joystick-view-horizontal").html());
        this.state = INACTIVE;
        this.x = 0;
        this.y = 0;
        this.canvas = null;
        ...
        this.sprite = loadSprite("static/public/joystick/button.png", function(){
            self.joyStickLoaded = true;
            self._tryCallback();
        });
        this.background = loadSprite("static/public/joystick/canvas.png", function(){
    ...
    _retractJoystickForInactivity: function(){
        ...
        setTimeout(function(){
            ...
            if(currentTime - that.lastTouch >= SECONDS_INACTIVE * 1000){
                that._retractToMiddle();
                that.renderSprite();
            }
            that._retractJoystickForInactivity();
    ...
    renderSprite: function(){
        ...
        var coords = this._cartesianToCanvas(this.x, 0);
    ...
    render: function(){
        ...
        this.canvas = this.$('#joystickCanvasHorizontal')[0];
